...
(function(e){e.drilldownSelector=function(s,t){var g,q,u,y,l,k,r,b,m,p,v,h,w,x,d,c;this.version="1.0.1";g=1;q=0;u=!1;y={containerClass:"drilldownSelectorContainer",loaderClass:"drilldownSelectorLoader",loaderText:"Loading...",menuClass:"drilldownSelectorMenu",navClass:"drilldownSelectorNav",navBackClass:"back",navBackText:"Back",navHomeClass:"home",navHomeText:"Home",hasSubsClass:"hasSubs",goBackClass:"goBack",checkboxClass:"checkbox",onChange:function(){return!1}};l=e(s);v=p=m=b=r=k=null;h='{"sections": [';
w=null;x="";d={};c={buildFramework:function(){k=e('<div class="'+d.containerClass+'"></div>').insertAfter(l);m=e('<div class="'+d.navClass+'"></div>').appendTo(k);p=e('<a href="#" class="'+d.navBackClass+'">'+d.navBackText+"</a>").appendTo(m);v=e('<a href="#" class="'+d.navHomeClass+'">'+d.navHomeText+"</a>").appendTo(m);r=e('<p class="'+d.loaderClass+'">'+d.loaderText+"</p>").appendTo(k);b=e('<div class="'+d.menuClass+'"></div>').appendTo(k)},buildJSON:function(){l.find("option").each(function(){var a=
e(this).text(),z=e(this).attr("value"),b=null,d=0,n=!1,b="",n=e(this).is(":selected")?!0:!1,f=!0;n&&(u?n=!1:u=!0);0<a.length&&(b=a.match(/^\-[\-]*\s/i),null!==b&&("object"===typeof b&&0<b.length&&"string"===typeof b[0])&&(d=b[0].replace(/\s/i,"").length,b=a.replace(b[0],""),(n=c.addSection(d,b,z,n))?(h+=n,g=d):(h+=c.endJSON(),f=!1)));return f});h+=c.endJSON();w=JSON.parse(h)},buildHTML:function(a){var b="",e=null,d=null;if(a.hasOwnProperty("sections")&&0<a.sections.length){b+="<ul>";for(e in a.sections)a.sections.hasOwnProperty(e)&&
