/* jQuery Drilldown Selector / version: 1.0.0 / author: Sean Metzgar */
(function(e){e.drilldownSelector=function(s,t){var g,q,u,y,k,l,r,b,m,p,v,h,w,x,d,c;this.version="1.0.0";g=1;q=0;u=!1;y={containerClass:"drilldownSelectorContainer",loaderClass:"drilldownSelectorLoader",loaderText:"Loading...",menuClass:"drilldownSelectorMenu",navClass:"drilldownSelectorNav",navBackClass:"back",navBackText:"Back",navHomeClass:"home",navHomeText:"Home",hasSubsClass:"hasSubs",goBackClass:"goBack",checkboxClass:"checkbox"};k=e(s);v=p=m=b=r=l=null;h='{"sections": [';w=null;x="";d={};c=
{buildFramework:function(){l=e('<div class="'+d.containerClass+'"></div>').insertAfter(k);m=e('<div class="'+d.navClass+'"></div>').appendTo(l);p=e('<a href="#" class="'+d.navBackClass+'">'+d.navBackText+"</a>").appendTo(m);v=e('<a href="#" class="'+d.navHomeClass+'">'+d.navHomeText+"</a>").appendTo(m);r=e('<p class="'+d.loaderClass+'">'+d.loaderText+"</p>").appendTo(l);b=e('<div class="'+d.menuClass+'"></div>').appendTo(l)},buildJSON:function(){k.find("option").each(function(){var a=e(this).text(),
...
c.goBack(!0)})},deselectCheckbox:function(){k.find("option:selected").prop("selected",!1);b.find("li").removeClass("selected")},selectCheckbox:function(a){var b=a.parent("a");a=a.parent("a").parent("li");b=b.attr("data-value");c.deselectCheckbox();a.addClass("selected");k.find("option[value="+b+"]").prop("selected",!0)},goBack:function(a){a="boolean"===typeof a?a:!1;c.deselectCheckbox();a?(b.find(".active").removeClass("active"),b.children("ul").addClass("active")):b.find(".active").removeClass("active").parents("ul:eq(0)").addClass("active");
c.fixHeight();c.checkBackButton()},goForward:function(a){a.hasClass(d.hasSubsClass)&&(c.deselectCheckbox(),b.find(".active").removeClass("active"),a.children("ul").addClass("active"),c.fixHeight(),c.checkBackButton())},checkBackButton:function(){b.children("ul").hasClass("active")?p.hide():p.show()},showLoader:function(){l.show();m.hide();b.hide();r.show()},showSelector:function(){l.show();r.hide();m.show();b.show()},fixHeight:function(){b.height(b.find(".active").height())}};this.init=function(){d=
e.extend({},y,t);k.hide();c.buildFramework();c.showLoader();window.setTimeout?window.setTimeout(function(){c.buildJSON();c.buildMenu();c.addClasses();c.addCheckboxes();c.addListeners();c.checkBackButton();c.showSelector();c.fixHeight()},1E3):(c.buildJSON(),c.buildMenu(),c.addClasses(),c.addCheckboxes(),c.addListeners(),c.checkBackButton(),c.showSelector(),c.fixHeight())};this.getValue=function(){var a=!1,a=k.val();switch(typeof a){case "string":break;case "object":a=0<a.length?a[0]:!1;break;default:a=
!1}return a};this.init()};e.fn.drilldownSelector=function(s){return this.each(function(){if(void 0===e(this).data("drilldownSelector")){var t=new e.drilldownSelector(this,s);e(this).data("drilldownSelector",t)}})}})(jQuery);